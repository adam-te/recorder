...
const RECORDING_DIRECTORY = join(RUNTIME_DIRECTORY, 'recording')
const GENERATED_DIRECTORY = join(RECORDING_DIRECTORY, 'generated')
...
async function generate() {
  ...
  await writeGeneratedSource(
    ...
    await bundle(join(RECORDING_DIRECTORY, 'injected', 'entry.ts'), {
