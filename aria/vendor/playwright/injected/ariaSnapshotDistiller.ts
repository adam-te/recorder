...
import { hasPointerCursor } from '../isomorphic/ariaSnapshot.ts';
import { normalizeWhiteSpace } from '../isomorphic/stringUtils.ts';

import type * as aria from '../isomorphic/ariaSnapshot.ts';
import type { AriaSnapshot, AriaTreeOptions } from './ariaSnapshot.ts';
