...
import { InvalidSelectorError, parseCSS } from './cssParser.ts';

import type { CSSComplexSelectorList } from './cssParser.ts';
export { InvalidSelectorError, isInvalidSelectorError } from './cssParser.ts';
