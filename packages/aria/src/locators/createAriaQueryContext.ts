...
import type { AriaLocatorStep } from '#aria/src/types/locators.ts'
import { getAriaRole, getElementAccessibleNameText, isElementHiddenForAria } from '#aria/vendor/playwright/injected/roleUtils.ts'
import { elementMatchesText, elementText, getElementLabels, type ElementText } from '#aria/vendor/playwright/injected/selectorUtils.ts'
import { normalizeWhiteSpace } from '#aria/vendor/playwright/isomorphic/stringUtils.ts'
