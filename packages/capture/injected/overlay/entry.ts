...
import { createRecordingOverlay, type RecordingOverlay } from '#capture/injected/overlay/createRecordingOverlay.ts'
import { DISPOSE_OVERLAY_FUNCTION_NAME, OVERLAY_CONFIG_NAME, RECORDER_UI_ATTRIBUTE, STOP_BINDING_NAME } from '#capture/protocol.ts'
import * as ariaRuntime from '@te/aria/browser'

import { formatPlaywrightLocator } from '@te/recorder-recording/playwright/locator'
