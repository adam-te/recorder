import { recordingRuntimeSource } from '#capture/generated/recordingRuntimeSource.generated.ts'
import type { CapturedInteraction } from '#capture/host/types.ts'
import { DISPOSE_OVERLAY_FUNCTION_NAME, INTERACTION_BINDING_NAME, OVERLAY_CONFIG_NAME, STOP_BINDING_NAME, type SerializedInteraction } from '#capture/protocol.ts'
