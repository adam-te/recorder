import { createRecordedAction } from '#capture/host/actions/createRecordedAction.ts'
import type { CapturedInteraction } from '#capture/host/types.ts'

import type { RecordedAriaSnapshot, Recording, RecordingSession } from '@te/recorder-recording'
