import { attachInjectedRecorder } from '#capture/host/attachInjectedRecorder.ts'
import { captureBrowserNavigation, type CapturedBrowserNavigation } from '#capture/host/captureBrowserNavigation.ts'
