...
It provides recording and snapshot validation, serialization, recording sessions, playback contracts, Playwright script generation, and ThousandEyes format conversion interfaces.
