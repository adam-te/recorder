...
Starting a recording prompts for an initial URL before opening the browser. That URL becomes the recording's reported start URL and the first replayable navigation action.
